...
{{--            </div>--}}
            <div class="col-md-12">
                <div class="row d-flex justify-content-center align-content-center loginFrom">
                    <div class="col-md-4 login-body p-0 m-0">
                        <div class="mb-4 text-center text-uppercase text-body login-header">
                            <h3 class="loginHeader">Log In</h3>
                        </div>
                        <form action="{{asset(route('login.check'))}}" method="post" class="login-main-from">
                            @csrf
                            @method('post')
                            <div class="form-group first field--not-empty">
                                <label for="username">Email</label>
                                <input type="text" class="form-control input-field" id="username" name="email" placeholder="Enter your mail">
                            </div>
                            ...
                            @enderror
                            <input type="submit" value="Log In" class="btn btn-block submit-buttom">
                        </form>
                    </div>
                </div>
            </div>
